...
export const SelectGroup: FC<SelectPrimitive.Group.Props> = ({
  className,
  ...props
}) => {
  return (
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=inline-end]:slide-in-from-left-2 relative isolate z-50 max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-y-auto overflow-x-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-150 data-closed:animate-out data-open:animate-in",
            className,
          )}
          {...props}
        >
...
export const SelectLabel: FC<SelectPrimitive.GroupLabel.Props> = ({
  className,
  ...props
}) => {
  return (
...
export const SelectSeparator: FC<SelectPrimitive.Separator.Props> = ({
  className,
  ...props
}) => {
  return (
