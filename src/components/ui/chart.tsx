...
const ChartStyle: FC<{ id: string; config: ChartConfig }> = ({
  id,
  config,
}) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: Dynamically generating CSS variables for chart theming
...
export const ChartLegendContent: FC<ChartLegendContentProps> = ({
  className,
  hideIcon = false,
  payload,
